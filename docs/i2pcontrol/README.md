...
Status: partial Proposal 170 support; M095-M096, M098-M103, and M107 closed; M097 and M104 closed as blocked; M126 historical requalification closed; M127 token-lifetime corrective closed; M128 bounded batch conformance closed; M129 non-loopback managed-TLS fail-closed corrective closed; M130 historical post-corrective requalification closed; M139 post-lifecycle requalification closed (historical current-head authority, superseded by M153); M140 residual streaming applicability re-freeze, M141 HTTP unique-local source-address completion, M142 HTTP SSLProxies + JumpList completion, M143 retained streaming Profile completion, M144 presentation UseSSL completion, M145 LeaseSet reply-bundling completion, and M146 outproxy-provider feasibility gate (blocked) recorded; M153 post-M146 current-head requalification closed as qualification ancestry; M154 signature-domain/security/exact-owner re-freeze closed (disposition C, M147 path blocked); M155 LeaseSet-security semantic/owner re-freeze closed (legacy AES disposition C, narrow blinding frozen); M156 neutral Red25519/blinding primitive closed (zero promotions); M157 neutral modern type-5 Encrypted LeaseSet2 publication primitive closed (zero promotions); M158 neutral standard lookup-secret/blinding and encrypted-service extended-B32 infrastructure closed (zero promotions); M159 neutral standard PSK client-authorization primitive closed (zero promotions); M160 neutral standard DH (X25519) client-authorization primitive closed (zero promotions); M161 legacy AES/LS1 feasibility gate closed outcome B (valid but blocked, zero production/promotions); M162 Proposal LeaseSet-security blocked integration closed (zero promotions, nine-file I2PControl subset); M152 final requalification closed safe partial / terminal (zero production/promotions, final authority); current matrix is `336/29/475` with 29 residual blockers (10 SigType + 4 UseOutproxyPlugin + 15 LeaseSet)
