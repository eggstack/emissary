...
Status: partial Proposal 170 support; M095-M096, M098-M103, and M107 closed; M097 and M104 closed as blocked; M126 historical requalification closed; M127 token-lifetime corrective closed; M128 bounded batch conformance closed; M129 non-loopback managed-TLS fail-closed corrective closed; M130 historical post-corrective requalification closed; M139 post-lifecycle requalification closed as current-head authority; M140 residual streaming applicability re-freeze, M141 HTTP unique-local source-address completion, M142 HTTP SSLProxies + JumpList completion, M143 retained streaming Profile completion, M144 presentation UseSSL completion, M145 LeaseSet reply-bundling completion, and M146 outproxy-provider feasibility gate (blocked) recorded; current matrix is `336/29/475` with 29 residual blockers (10 SigType + 4 UseOutproxyPlugin + 15 LeaseSet)
