...
Status: partial Proposal 170 support; M093 production/security reclosure, M095-M099 completion slices, and M100-M103 source closures recorded; M104/M112/M113 closed as blocked; M121 corrective demotion, M125 capability/crypto audit, M126 historical requalification, M131 residual re-freeze, M135 neutral live-quantity primitive, M136 Reduce completion, M137 Close completion, M134 NewDest proven-resume completion, M139 historical post-lifecycle requalification (superseded by M153), M140 residual streaming applicability re-freeze, and M141 HTTP unique-local source-address completion and M142 HTTP SSLProxies + JumpList completion and M143 retained streaming Profile completion and M144 presentation UseSSL completion and M145 LeaseSet reply-bundling completion and M146 outproxy-provider feasibility gate (blocked, zero promotions) and M153 post-M146 current-head requalification (closed, current-head authority, zero promotions) and M154 signature-domain/security/exact-owner re-freeze (closed, disposition C, M147 path blocked, zero promotions) and M155 LeaseSet-security semantic/owner re-freeze (closed, legacy AES disposition C, narrow blinding frozen, zero promotions) and M156 neutral Red25519/blinding primitive (closed, zero promotions) and M157 neutral modern type-5 Encrypted LeaseSet2 publication primitive (closed, zero promotions) and M158 neutral standard lookup-secret/blinding and encrypted-service extended-B32 infrastructure (closed, zero promotions) and M159 neutral standard PSK client-authorization primitive (closed, zero promotions) and M160 neutral standard DH (X25519) client-authorization primitive (closed, zero promotions) and M161 legacy AES/LS1 feasibility gate (closed outcome B, valid but blocked, zero production/promotions) and M162 Proposal LeaseSet-security blocked integration (closed, zero promotions) and M152 final requalification (closed safe partial / terminal, zero production/promotions, final authority) recorded; residual option cells remain (29 blocked: 10 SigType + 4 client proxy/lifecycle + 15 server LeaseSet/presentation, with 2 UniqueLocalAddressPerClient applied by M141 and 2 SSLProxies/JumpList applied by M142 and 1 Profile applied by M143 and 4 UseSSL applied by M144 and 2 MultiHoming applied by M145 and zero UseOutproxyPlugin applied by M146 and zero SigType applied — M147 path blocked)
...
- authoritative aggregate matrix: `plans/implementation/i2pcontrol-proposal-170/095-full-support-matrix.toml` (`336/29/475`); current runtime/security qualification: `plans/closure/i2pcontrol-proposal-170/153-closure.md` (M153; M139 `plans/closure/i2pcontrol-proposal-170/139-closure.md` is historical); signature-domain/security/exact-owner re-freeze: `plans/closure/i2pcontrol-proposal-170/154-closure.md` (M154, disposition C, M147 path blocked); LeaseSet-security semantic/owner re-freeze: `plans/closure/i2pcontrol-proposal-170/155-closure.md` (M155, legacy AES disposition C, narrow blinding frozen); neutral Red25519/blinding primitive: `plans/closure/i2pcontrol-proposal-170/156-closure.md` (M156, zero promotions); modern type-5 Encrypted LeaseSet2 publication: `plans/closure/i2pcontrol-proposal-170/157-closure.md` (M157, zero promotions); lookup-secret/blinded-address primitive: `plans/closure/i2pcontrol-proposal-170/158-closure.md` (M158, zero promotions); PSK client-authorization primitive: `plans/closure/i2pcontrol-proposal-170/159-closure.md` (M159, zero promotions); DH (X25519) client-authorization primitive: `plans/closure/i2pcontrol-proposal-170/160-closure.md` (M160, zero promotions); residual streaming applicability: `plans/closure/i2pcontrol-proposal-170/140-closure.md`; residual streaming applicability: `plans/closure/i2pcontrol-proposal-170/140-closure.md`; HTTP unique-local source-address completion: `plans/closure/i2pcontrol-proposal-170/141-closure.md`; HTTP SSLProxies + JumpList completion: `plans/closure/i2pcontrol-proposal-170/142-closure.md`; retained streaming Profile completion: `plans/closure/i2pcontrol-proposal-170/143-closure.md`; presentation UseSSL completion: `plans/closure/i2pcontrol-proposal-170/144-closure.md`; LeaseSet reply-bundling completion: `plans/closure/i2pcontrol-proposal-170/145-closure.md`; outproxy-provider feasibility gate: `plans/closure/i2pcontrol-proposal-170/146-closure.md` (blocked); legacy AES/LS1 gate: `plans/closure/i2pcontrol-proposal-170/161-closure.md` (outcome B, zero production/promotions); Proposal LeaseSet-security field integration: `plans/closure/i2pcontrol-proposal-170/162-closure.md` (blocked integration, zero promotions); final requalification: `plans/closure/i2pcontrol-proposal-170/152-closure.md` (safe partial / terminal, final authority)
...
`partial Proposal 170 support` because the full Proposal 170 contract still has
unimplemented administrative operations and lacks live interoperability evidence.
M066 adds real filtered `ircclient` and
...
former unavailable banned-peer row is now an authoritative empty map under M103;
M100 and M101 provide bounded transit-15s and signed router-news sources, and
M102 provides explicit neutral v4/v6 network-error state from the existing SSU2
reachability owner.
...
`plans/closure/i2pcontrol-proposal-170/113-closure.md`, and
...
Current source matrix after M103:
...
before a validated generation or after seven days of failed refreshes. The banned-peer
selector returns the authoritative empty map from the explicit by-design-empty
capability marker; this does not implement ban management. Other unavailable
selectors fail with sanitized errors before assembly and never return fabricated zero,
false, empty, partial, or semantically adjacent values. Once the existing reachability
...
| M102 | closed | explicit neutral v4/v6 network-error owner; prior 41/1/1 source matrix |
| M103 | closed | authoritative by-design-empty banned-peer source; current 42/1/0 source matrix |
