...
source disposition for every addition: 37 available, 1 protocol-permitted
neutral, and 5 unavailable. Known-peer, active-peer, transport, tunnel, and
v4/v6 status/testing fields use bounded live owners; router news, ban, the
15-second transit-bandwidth field, and v4/v6 network-error fields remain
unavailable because no canonical owner exists for those facts.
