...
fn m061_source_boundary_files_remain_unchanged() {
    ...
    assert!(
        ...
        "M118/M156/M157 may amend only the exact construction seam and the exact \
         crypto exception in M061 authority: {changed}"
    );
    // M157 exact-exception reconciliation: the M061 guard must still prohibit
    // broad crypto prefixes while authorizing only the exact sensitive files.
    let m061_source =
        std::fs::read_to_string(workspace_root().join("emissary-cli/tests/m061_containment.rs"))
            .expect("read M061 guard");
    assert!(
        m061_source.contains("is_authorized_sensitive_core_exception"),
        "M061 guard must record the exact sensitive-core exception"
    );
    assert!(
        m061_source.contains("emissary-core/src/crypto/mod.rs")
            && m061_source.contains("emissary-core/src/crypto/red25519.rs")
            && m061_source.contains("emissary-core/src/crypto/els2.rs")
            && m061_source.contains("emissary-core/src/i2np/database/store.rs")
            && m061_source.contains("emissary-core/src/netdb/mod.rs"),
        "M061 guard must authorize only the exact sensitive core files"
    );
}
...
fn allowed_production_paths_match_the_m062_budget() {
    ...
    for path in &changed {
        ...
        // M128/M129/M130 share the reopened-line budget with M127; fold them
        ...
        let authorized_m141 = is_authorized_m141_path(path);
        ...
        let authorized_m164 = is_authorized_m164_path(path);
...
fn is_authorized_m136_path(path: &str) -> bool {
    matches!(
        path,
...
fn is_authorized_m134_path(path: &str) -> bool {
    matches!(
        path,
        "emissary-cli/src/i2pcontrol/idle_resume.rs"
            | "emissary-cli/src/i2pcontrol/mod.rs"
            | "emissary-cli/src/i2pcontrol/client_secret_store.rs"
            | "emissary-cli/src/i2pcontrol/backends/runtime/session.rs"
            | "emissary-cli/src/i2pcontrol/backends/runtime/client_listener.rs"
...
fn is_authorized_m141_path(path: &str) -> bool {
    matches!(
        path,
        "AGENTS.md"
            | "docs/i2pcontrol/proposal-170-support.md"
            ...
            | "plans/closure/i2pcontrol-proposal-170/141-closure.md"
            | "plans/implementation/i2pcontrol-proposal-170/095-full-support-matrix.toml"
            | "plans/implementation/i2pcontrol-proposal-170/110-completion-ledger.toml"
...
fn is_authorized_m142_path(path: &str) -> bool {
    matches!(
        path,
        "AGENTS.md"
            | "docs/i2pcontrol/proposal-170-support.md"
            ...
            | "plans/closure/i2pcontrol-proposal-170/142-closure.md"
            | "plans/implementation/i2pcontrol-proposal-170/095-full-support-matrix.toml"
            | "plans/implementation/i2pcontrol-proposal-170/110-completion-ledger.toml"
...
fn is_authorized_m143_path(path: &str) -> bool {
    matches!(
        path,
        "AGENTS.md"
            | "docs/i2pcontrol/proposal-170-support.md"
            ...
            | "plans/closure/i2pcontrol-proposal-170/143-closure.md"
            | "plans/implementation/i2pcontrol-proposal-170/061-containment-boundary.toml"
            | "plans/implementation/i2pcontrol-proposal-170/095-full-support-matrix.toml"
            | "plans/implementation/i2pcontrol-proposal-170/110-completion-ledger.toml"
...
fn is_authorized_m144_path(path: &str) -> bool {
    matches!(
        path,
        "AGENTS.md"
            | "docs/i2pcontrol/proposal-170-support.md"
            ...
            | "emissary-cli/src/i2pcontrol/backends/http_server.rs"
            | "emissary-cli/src/i2pcontrol/backends/runtime/mod.rs"
            | "emissary-cli/src/i2pcontrol/backends/runtime/presentation_tls.rs"
            | "emissary-cli/src/i2pcontrol/production.rs"
            | "emissary-cli/tests/m062_dependency_containment.rs"
            | "emissary-cli/tests/m095_full_support_matrix.rs"
            | "emissary-cli/tests/m105_residual_option_audit.rs"
            | "emissary-cli/tests/m144_presentation_usessl.rs"
            | "plans/closure/i2pcontrol-proposal-170/144-closure.md"
            | "plans/implementation/i2pcontrol-proposal-170/095-full-support-matrix.toml"
            | "plans/implementation/i2pcontrol-proposal-170/110-completion-ledger.toml"
...
fn is_authorized_m146_path(path: &str) -> bool {
    matches!(
        path,
        "AGENTS.md"
            | "docs/i2pcontrol/README.md"
            ...
            | "docs/i2pcontrol/tunnel-backends.md"
            | "emissary-cli/tests/m062_dependency_containment.rs"
            | "emissary-cli/tests/m146_outproxy_provider_blocked.rs"
...
fn is_authorized_m153_path(path: &str) -> bool {
    matches!(
        path,
        "AGENTS.md"
            | "docs/i2pcontrol/README.md"
            ...
            | "emissary-cli/tests/m143_streaming_profile.rs"
            | "emissary-cli/tests/m144_presentation_usessl.rs"
            | "emissary-cli/tests/m153_post_m146_requalification.rs"
...
fn is_authorized_m157_path(path: &str) -> bool {
    matches!(
        path,
        "AGENTS.md"
            | "docs/i2pcontrol/README.md"
            ...
            | "emissary-core/src/primitives/mod.rs"
...
fn is_authorized_m159_path(path: &str) -> bool {
    matches!(
        path,
        "AGENTS.md"
            | "docs/i2pcontrol/README.md"
            ...
            | "emissary-core/src/sam/parser.rs"
            | "emissary-core/src/sam/session.rs"
            | "plans/closure/i2pcontrol-proposal-170/159-closure.md"
            | "plans/implementation/i2pcontrol-proposal-170/062-dependency-containment.toml"
            | "plans/implementation/i2pcontrol-proposal-170/159-leaseset-psk-client-authorization-primitive.md"
...
fn is_authorized_m160_path(path: &str) -> bool {
    matches!(
        path,
        "AGENTS.md"
            | "docs/i2pcontrol/README.md"
            ...
            | "emissary-core/src/sam/parser.rs"
            | "emissary-core/src/sam/session.rs"
            | "plans/closure/i2pcontrol-proposal-170/160-closure.md"
            | "plans/implementation/i2pcontrol-proposal-170/062-dependency-containment.toml"
            | "plans/implementation/i2pcontrol-proposal-170/160-leaseset-dh-client-authorization-primitive.md"
...
fn is_authorized_m161_path(path: &str) -> bool {
    matches!(
        path,
        "AGENTS.md"
            | "docs/i2pcontrol/README.md"
...
fn is_authorized_m164_path(path: &str) -> bool {
    matches!(
        path,
        "AGENTS.md"
            | "emissary-core/src/sam/socket.rs"
            | "emissary-cli/tests/m062_dependency_containment.rs"
            | "emissary-cli/tests/m163_registration_guard.rs"
            | "plans/closure/i2pcontrol-proposal-170/164-closure.md"
            | "plans/implementation/i2pcontrol-proposal-170/062-dependency-containment.toml"
            | "plans/implementation/i2pcontrol-proposal-170/164-sam-invalid-command-secret-redaction-corrective.md"
            | "plans/implementation/i2pcontrol-proposal-170/165-post-corrective-current-head-requalification.md"
            | "plans/implementation/i2pcontrol-proposal-170/README.md"
...
fn is_authorized_m127_path(path: &str) -> bool {
    matches!(
        path,
        "docs/i2pcontrol/README.md"
            | "emissary-cli/src/i2pcontrol/auth.rs"
...
fn is_authorized_m130_path(path: &str) -> bool {
    matches!(
        path,
        "docs/i2pcontrol/README.md"
            | "emissary-cli/tests/m130_post_corrective_requalification.rs"
...
fn read_planning_file(path: &str) -> String {
    std::fs::read_to_string(workspace_root().join(path))
        .unwrap_or_else(|error| panic!("read {path}: {error}"))
}

#[test]
fn current_registration_and_m164_closure_are_exact_and_zero_dependency() {
    ...
    let paths = registration
        ...
        .and_then(toml::Value::as_array)
        .expect("M165 production_paths")
        .iter()
        .map(|value| value.as_str().expect("production path string"))
        .collect::<BTreeSet<_>>();
    assert!(paths.is_empty(), "M165 must authorize no production paths");

    let m164 = manifest
        .get("m164_closure")
        .and_then(toml::Value::as_table)
        .expect("M164 closure table");
    assert_eq!(
        m164.get("milestone").and_then(toml::Value::as_str),
        Some("M164 (closed as complete; zero promotions)")
    );
    let m164_paths = m164
        .get("production_paths")
        .and_then(toml::Value::as_array)
        .expect("M164 closure production_paths")
        .iter()
        .map(|value| value.as_str().expect("production path string"))
        .collect::<BTreeSet<_>>();
    assert_eq!(
        m164_paths,
        ["emissary-core/src/sam/socket.rs"].into_iter().collect::<BTreeSet<_>>(),
        "M164 closure budget must remain exact"
    );

    for key in ["new_files", "new_direct_dependencies", "manifest_changes"] {
        assert!(
            registration.get(key).and_then(toml::Value::as_array).is_some_and(Vec::is_empty),
            "M165 {key} must remain empty"
        );
    }
    assert_eq!(
...
fn m164_is_closed_and_m165_is_the_registered_successor() {
    ...
    assert!(m164.contains("Status: **closed as complete**"));
...
#[test]
fn m163_budget_stays_inside_m061_i2pcontrol_policy_root() {
    let raw = read_planning_file(
        "plans/implementation/i2pcontrol-proposal-170/062-dependency-containment.toml",
    );
    let manifest: toml::Value = toml::from_str(&raw).expect("valid M062 TOML");
    let paths = manifest["m164_closure"]["production_paths"]
        .as_array()
        .expect("M164 production paths");
    assert_eq!(paths.len(), 1);
    assert_eq!(paths[0].as_str(), Some("emissary-core/src/sam/socket.rs"));

    let m061 = read_planning_file(
        "plans/implementation/i2pcontrol-proposal-170/061-containment-boundary.toml",
    );
