...
StartOnLoad. M035 is now the only dependency-ready implementation plan. These
...
| M034 — AddressBook setter truthfulness | closed | `034-addressbook-setter-truthfulness.md` | M033 closed |
| M035 — Base compatibility and selector overlap | ready | `035-base-compatibility-and-selector-overlap.md` | M034 closed |
