...
|---|---|---|---|---|
| I2PControl Proposal 170 | partial Proposal 170 support; operational corrective work active | `plans/subsystems/i2pcontrol-proposal-170-roadmap.md` | M035 ready | M030–M034 closed; M035 is the only dependency-ready plan |

## Dependency-ready implementation plans

| Subsystem | Handoff | Status | Implementation plan | Dependencies |
|---|---|---|---|---|
| I2PControl Proposal 170 | M035 — Base compatibility and selector overlap | ready | `plans/implementation/i2pcontrol-proposal-170/035-base-compatibility-and-selector-overlap.md` | M034 closed; ADR-0002 accepted |
...
| I2PControl Proposal 170 | M035 — Base compatibility and selector overlap | ready | `plans/implementation/i2pcontrol-proposal-170/035-base-compatibility-and-selector-overlap.md` | M034 closed |
...
|---|---|---|---|---|
| — | None | — | M034 closure accepted; M035 is ready for handoff | — |
...
| Base I2PControl dispatcher/overlapping RouterInfo names require explicit compatibility boundary | medium compatibility gap | M035 | ready |
...
1. M035 is the only dependency-ready implementation handoff.
2. Do not advance M036 until M035 implementation disposition and closure are accepted.
