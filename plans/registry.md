...
| I2PControl Proposal 170 tunnel security hardening | planned corrective; M077 closed | `plans/subsystems/i2pcontrol-proposal-170-tunnel-security-hardening-roadmap.md` | M078 — Streamr local-boundary hardening | M078 is the next registered handoff; M079 remains blocked until M078 closes |
...
|---|---|---|---|
| M078 — Streamr local-boundary hardening | ready | `plans/implementation/i2pcontrol-proposal-170/078-streamr-local-boundary-hardening.md` | close the local UDP trust boundary and align bounded Streamr fanout |

Per `plans/003-planning-process.md`, only the next dependency-ready implementation plan is registered as ready. M079 remains blocked until M078 closes.
...
M071-M077 are closed. M078 is the current registered handoff. M079 remains
blocked by its named dependency.

## Prewritten blocked tunnel-security successors

The post-M072 security/anonymity review establishes a separate bounded corrective sequence. M073-M077 are closed; M078 is next and none of the later plans leapfrogs it.
...
| M078 — Streamr local-boundary hardening | ready | `plans/implementation/i2pcontrol-proposal-170/078-streamr-local-boundary-hardening.md` | M075-M077 closed; next registered handoff |
...
2. M064-M077 are closed; M078 is the current dependency-ready handoff.
3. M079 remains blocked until M078 closes.
