...
|---|---|---|---|---|
| I2PControl Proposal 170 | partial Proposal 170 support; operational corrective work active | `plans/subsystems/i2pcontrol-proposal-170-roadmap.md` | M034 ready | M030–M033 closed; M034 is the only dependency-ready plan |

## Dependency-ready implementation plans

| Subsystem | Handoff | Status | Implementation plan | Dependencies |
|---|---|---|---|---|
| I2PControl Proposal 170 | M034 — AddressBook setter truthfulness | ready | `plans/implementation/i2pcontrol-proposal-170/034-addressbook-setter-truthfulness.md` | M033 closed; ADR-0002 accepted |
...
| I2PControl Proposal 170 | M034 — AddressBook setter truthfulness | ready | `plans/implementation/i2pcontrol-proposal-170/034-addressbook-setter-truthfulness.md` | M033 closed |
...
|---|---|---|---|---|
| — | None | — | M033 closure accepted; M034 is ready for handoff | — |
...
| AddressBook SetSubscriptions/SetConfig can report success for inert metadata | high API truthfulness gap | M034 | ready |
...
1. M034 is the only dependency-ready implementation handoff.
2. Do not advance M035 until M034 implementation disposition and closure are accepted.
